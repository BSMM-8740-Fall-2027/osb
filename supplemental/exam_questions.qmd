...
Here are examples of the applied questions that might be asked (**Note**: [will require code]{.underline}):

Given the `ggplot2::diamonds` dataset, using tidyverse functions:
