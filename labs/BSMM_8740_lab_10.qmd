...
-   To complete the lab, log on to **your** github account and then go to the class [GitHub organization](https://github.com/bsmm-8740-fall-2024) and find the **2027-lab-10-\[your github username\]** repository .

    Create an R project using your **2027-lab-10-\[your github username\]** repository (remember to create a PAT, etc.) and add your answers by editing the `2027-lab-10.qmd` file in your repository.
