...
2.  Next, in a new browser tab, go to the course organization site at [BSMM-8740-Fall-2025](https://github.com/BSMM-8740-Fall-2025/ "Course GitHub organization") on GitHub. On the right hand side of the page you will find a list of repositories. Click on the repo **2025-lab-1\_*your.github.username***. It contains the starter documents you need to complete the lab.
...
7.  Click *2025-lab-1.qmd* to open the template R Markdown file. This is where you will write up your code and narrative for the lab.
