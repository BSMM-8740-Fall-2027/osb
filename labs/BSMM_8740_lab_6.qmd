...
-   To complete the lab, log on to **your** github account and then go to the class [GitHub organization](https://github.com/bsmm-8740-fall-2027) and find the **2027-lab-6-\[your github username\]** repository .

    Create an R project using your **2027-lab-6-\[your github username\]** repository (remember to create a PAT, etc.) and add your answers by editing the `2027-lab-6.qmd` file in your repository.
...
::: callout-important
Which is the best model by the (smallest) **rmse** metric? \_\_\_\_\_\_\_\_\_\_\_\_\_\_
:::
::::
...
# create the workflows and fit the models ----
workflow_fit_AAA <- ?
  
workflow_fit_MMM <- ?  
  
# predict one month ahead, to Jan 2024 using modeltime::modeltime_calibrate and modeltime::modeltime_forecast ----
  
predictions <- ?  
  
# plot the predictions ----
predictions |> dplyr::slice_tail(n=2)
predictions |> 
...
Which model should you present to management? \_\_\_\_\_\_\_\_
:::
