...
-   Log in to **your** github account and then go to the [GitHub organization](https://github.com/bsmm-8740-fall-2027) for the course and find the **2027-lab-4-\[your github username\]** repository to complete the lab.

    Create an R project using your **2027-lab-4-\[your github username\]** repository (remember to create a PAT, etc., as in lab-1) and add your answers by editing the `2027-lab-4.qmd` file in your repository.
