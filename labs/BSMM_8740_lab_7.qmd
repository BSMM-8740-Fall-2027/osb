...
-   To complete the lab, log on to **your** github account and then go to the class [GitHub organization](https://github.com/bsmm-8740-fall-2027) and find the **2027-lab-7-\[your github username\]** repository .

    Create an R project using your **2027-lab-7-\[your github username\]** repository (remember to create a PAT, etc.) and add your answers by editing the `2027-lab-7.qmd` file in your repository.
...
```{r}
#| echo: false
#| label: build the DAGs and display them
# (1)
dag_1 <- 
ggdag::dagify(
  A ~ D
...
What data might be missing from the company data / this DAG, if any: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
:::
...
```{r}
#| label: compare your weights with those of the function wt_ate in the propensity package
...
Let's fit a model with these variables. Note that we'll also fit all continuous variables with squared terms, to allow them a bit of flexibility.
...
-   causal workflow steps: \_\_\_\_\_

-   your critique of the results of the exercise: \_\_\_\_\_\_
:::
...
-   Define the following parameters using Rubin's notation:
    ...
    -   Average Treatment Effect (ATE): \_\_\_\_\_
    -   Average Treatment Effect on the Treated (ATT): \_\_\_\_\_
    -   Average Treatment Effect on the Untreated (ATU): \_\_\_\_\_

-   What is the observed difference in means❓ \_\_\_\_\_

    -   What does this estimate capture❓ \_\_\_\_\_

-   If the true ATE = \$25, what is the selection bias❓ \_\_\_\_\_
...
2.  Use econ_data to model the "reduced form" stage by regressing log(quantity) with shipping_cost.
