---
title: "Causality"
subtitle: "BSMM8740-2-R-2027F [WEEK - 7]"
author: "L.L. Odette"
...
#| fig.height: 4
#| echo: false
#| fig.cap: A love plot representing the standardized mean differences (SMD) between exposure groups of three confounders - temperature, income, and health. Before weighting, there are considerable differences in the groups. After weighting, the confounders are much more balanced between groups.
#
plot_df <- tidysmd::tidy_smd(
  net_data_wts,
  c(income, health, temperature),
...
tipping_points <- 
  tipr::tip_coef(effect_observed = boot_estimate$.upper, exposure_confounder_effect = 1:5)
