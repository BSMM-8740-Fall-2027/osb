...
we say the treated and untreated populations are [**exchangeable**]{.underline}. This is equivalent to saying that the joint distribution of potential outcomes is independent of treatment assignment: $\left(Y^1,Y^0\right)\perp\!\!\!\!\perp D$.
:::
...
If in addition we have a covariate $x$ that split our data into groups, we can imagine a causal effect estimate by groups, which is then combined into an overall estimate:
