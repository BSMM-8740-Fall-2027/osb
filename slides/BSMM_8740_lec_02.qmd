...
knitr::include_graphics("images/small_bizsvd-rank-growth.gif", dpi=300)
```
:::
...
#| label: plot of cumulative variance explained
#| fig-width: 5  
#| fig-height: 5  
#| fig-align: center
...
::: {style="font-size: x-large"}
This example has 1000 customers and 100 products.
:::
