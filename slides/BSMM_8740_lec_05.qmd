...
-   Let our decision boundary be given by $f\left(x\right)=w^{\top}x+w_{0}=0$, for a vector $w$ perpendicular to the boundary[^5].
...
[^5]: any point $x$ on the red line satisfies $w^\top x+w_0=0$
